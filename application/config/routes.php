...
*/
// $route['default_controller'] = 'Welcome';
$route['default_controller'] = 'SiteRegistrationController/getAllSites';
$route['test-route'] = 'Welcome/test_route';
...
$route['sites/delete'] = 'SiteRegistrationController/postDeleteSite';


// $route['custom-prompt'] = 'CustomPromptController/getAllCustomPrompts';
$route['custom-prompt/id/(:any)'] = 'CustomPromptController/getSiteCustomPrompts/$1';
$route['custom-prompt/save'] = 'CustomPromptController/postSaveCustomPrompts';
